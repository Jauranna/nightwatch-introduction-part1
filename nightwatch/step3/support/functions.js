...
/**
     * Looks over the UI to make sure needed elements are visible and displaying correct text. (buttons and display)
     * 
     * @param {object} browser an object provided by NightwatchJS which hooks into the text browser
     */
